...
public class Fabrica {
        ...
        public static void setArsenalArmas(List<Arma> arsenalArmas) { Fabrica.arsenalArmas = arsenalArmas; }
        public static void setArsenalMag(List<Carregador> arsenalMag) { Fabrica.arsenalMag = arsenalMag; }
        public static void setArsenalBullet(List<Municao> arsenalBullet) { Fabrica.arsenalBullet = arsenalBullet; }
}